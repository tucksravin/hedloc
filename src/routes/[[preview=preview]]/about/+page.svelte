<script lang='ts'>
  ...
  <section class="bg-light py-24">
    ...
    <ContentWidth class="flex flex-col lg:flex-row justify-end relative lg:h-[600px] gap-10" >
        <div class="lg:w-1/4 flex flex-col items-start justify-start gap-2 z-20" id="team-top">
            {#if active>-1}
